...
### 0.1 — 95 % des pilotes au point mort
...
### 0.2 — La maturité d'une fabrique se lit dans ses artefacts
...
![SCHÉMA 01 — L'oignon ↔ la fabrique|1300](images/20260515-01-oignon-fabrique.svg)

### 0.4 — Dix artefacts pour une fabrique
...
### 0.5 — Trois parcours pour trois lecteurs
...
### 1.1 — Un dev, un notebook, un prompt qui grossit
...
![SCHÉMA 02 — L'atelier · Stade 1 (Prototype)|1300](images/20260515-02-atelier-prototype.svg)
...
### 1.2 — Cinq artefacts encore en brouillon
...
![SCHÉMA 03 — Anatomie du prompt v0 comme palimpseste|1300](images/20260515-03-prompt-palimpseste.svg)
...
### 1.4 — Premier utilisateur réel = fin du privilège
...
### 2.1 — Un PO arrive, un dashboard s'allume
...
![SCHÉMA 04 — L'atelier · Stade 2 (Pilote)|1300](images/20260515-04-atelier-pilote.svg)
...
### 2.2 — Sept artefacts naissent au Pilote
...
![SCHÉMA 05 — Anatomie d'un TestCase|1300](images/20260515-05-testcase-anatomie.svg)
...
### 2.3 — Pourquoi 70 % des pilotes meurent ici
...
![SCHÉMA 06 — La vallée de la mort des pilotes|1300](images/20260515-06-vallee-de-la-mort.svg)
...
### 2.5 — Un SLA promis = passage en Production
...
### 3.1 — Quatre personnages tiennent l'arbitrage
...
![SCHÉMA 07 — L'atelier · Stade 3 (Production)|1300](images/20260515-07-atelier-production.svg)
...
### 3.2 — Neuf artefacts à l'échelle Production
...
![SCHÉMA 09 — OBO vs Régime autonome — la facture cachée|1300](images/20260515-09-obo-vs-autonome.svg)
...
![SCHÉMA 08 — Le gruyère suisse de l'évaluation|1300](images/20260515-08-gruyere-suisse.svg)
...
### 3.3 — Quand on dégrade : pass^k, fallback, refus poli
...
### 3.4 — « Le runbook est à jour, personne ne l'a lu »
...
### 3.5 — Un deuxième agent arrive = passage en Mature
...
### 4.1 — Les humains passent en coulisses
...
![SCHÉMA 10 — L'atelier · Stade 4 (Mature multi-agents)|1300](images/20260515-10-atelier-mature.svg)
...
### 4.2 — Six artefacts qui fusionnent au stade Mature
...
![SCHÉMA 11 — La mémoire CoALA en cycle|1300](images/20260515-11-coala-cycle.svg)
...
![SCHÉMA 11 bis — Les 15 ROI cards · 5 axes × 3 temporalités|1300](images/20260515-13-roi-cards.svg)

Le schéma ci-dessus déploie la matrice complète : chaque cellule porte le type de gain, le mode de calcul canonique et la qualification Hard/Soft selon la grille Cigref. À lire comme un système de scoring, pas comme une checklist — une fabrique mature en renseigne rarement plus de six à huit simultanément.
...
### 4.3 — Le travail se déplace plus qu'il ne disparaît
...
### 4.4 — « Les agents écrivent leur mémoire mais ne la lisent jamais »
...
### 5.1 — Dix artefacts × quatre stades, en une partition

![SCHÉMA 12 — Récap · 10 artefacts × 4 stades|1300](images/20260515-12-recap-10x4.svg)
...
### 5.2 — Trois questions, une par persona
...
### 5.3 — Le travail n'est pas un destin technologique
...
Les liens pointent vers le rapport markdown intégral de chaque dossier (l'app interactive en présente une version HTML conversion).

| Pour creuser | Aller voir |
|---|---|
| Anatomie d'un agent (10 couches · boucle ReAct · domestiquer la variance) | [`anatomie`](../anatomie/) |
| Le harness en profondeur (7 couches · pattern GAN · wide tools · file-based handoff) | [`harness-agentique/20260429-harness-agentique-rapport.md`](../harness-agentique/20260429-harness-agentique-rapport.md) |
| OTel GenAI · 6 piliers · N1→N5 · cognitive audit trail | [`observabilite-agents-ia/20260430-observabilite-agents-ia-rapport.md`](../observabilite-agents-ia/20260430-observabilite-agents-ia-rapport.md) |
| TestCase · gruyère suisse · LLM-as-judge biais · CLEAR · 8 étapes playbook | [`evaluation-agentique/20260501-evaluation-agentique-rapport.md`](../evaluation-agentique/20260501-evaluation-agentique-rapport.md) |
| CoALA · cycle 6 opérations · 5 frameworks · memory poisoning | [`memoire-agentique/20260430-memoire-agentique-rapport.md`](../memoire-agentique/20260430-memoire-agentique-rapport.md) |
| 14 piliers · 3 lignes de défense · OBO vs Autonome · Entra Agent ID | [`gouvernance`](../gouvernance/) |
| 5 axes ROI · 8 méthodes de calcul · 15 ROI cards | [`measure-roi/20260507-roi-ia-generative-agentique-rapport.md`](../measure-roi/20260507-roi-ia-generative-agentique-rapport.md) |
| Augmentation vs automatisation · pause d'Engels · reverse skill bias · 6 leviers Acemoglu | [`ia-et-travail/20260504-ia-et-travail-rapport.md`](../ia-et-travail/20260504-ia-et-travail-rapport.md) |
| Coût d'inférence · routing économique · TCO self-host vs managed | [`economie-inference/20260506-economie-inference-rapport.md`](../economie-inference/20260506-economie-inference-rapport.md) |
