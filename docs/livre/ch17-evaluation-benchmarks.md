...
### 17.2.1 Première époque — IA classique : la dictature du F1
...
### 17.2.2 Deuxième époque — IA générative : la déroute des n-grammes
...
### 17.2.3 Troisième époque — IA agentique : la trajectoire devient l'objet d'évaluation
...
### 17.3.1 Vocabulaire de référence
...
**Model-based graders.** LLM-as-a-judge sous différentes modalités : rubric scoring, natural language assertion, pairwise comparison, reference-based, multi-judge consensus. Flexibles, scalables, nuancés, gèrent le freeform ; non-déterministes, plus chers, requièrent une calibration humaine pour fiabilité (cf. §17.6).
...
### 17.6.1 Quatre modes opératoires
...
### 17.6.2 Cinq biais systématiques documentés
...
### 17.6.3 Pipeline correctif — ce qui marche en production
...
### 17.6.4 Quand ne pas utiliser un juge LLM
...
### 17.6.5 Économie — les SLM-judges spécialisés
...
### 17.7.2 τ-bench et τ²-bench — single-control vs dual-control
...
## 17.9 Les quatre vecteurs de fuite (R12)
...
### 17.9.1 Chevauchement train/test temporel — vecteur (i)
...
### 17.9.2 Fuite par version-tag — vecteur (ii)
...
### 17.9.3 Gaming du harnais — vecteur (iii)
...
## 17.14 Le playbook gruyère en 8 étapes (R11)
...
### 17.14.2 Étape 1 — Partir du manuel
...
### 17.14.3 Étape 2 — Tasks unambiguës avec reference solutions
...
### 17.14.4 Étape 3 — Problem sets équilibrés
...
### 17.14.5 Étape 4 — Eval harness robuste avec environnement stable
...
### 17.14.6 Étape 5 — Graders thoughtfully designés
...
### 17.14.7 Étape 6 — Lire les transcripts
...
### 17.14.8 Étape 7 — Monitorer la saturation
...
### 17.14.9 Étape 8 — Ownership et contribution
...
### 17.16.2 Token cost trap — la rupture POC → production
...
### 17.16.3 Les vrais goulots ne sont pas techniques
