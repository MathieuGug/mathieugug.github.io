...
> [!INFO] Source vivante
> Le journal quotidien en ligne — tenu depuis le 1ᵉʳ mai 2026 — reste la source vivante pour les évolutions post-27 mai. La présente lecture est stabilisée à la fin de la **semaine 1 post-verdict**. Les semaines 2 à 9 (mi-juillet 2026, première collision calendaire entre la réponse Bonta et le *tender closing*) seront couvertes uniquement par le journal en ligne — seul corpus *veille en temps réel* assumé comme tel.

---

## Sources

[^proces-musk-altman-dossier]: Guglielmino, M. *Procès Musk v. Altman : la mission caritative d'OpenAI à l'épreuve du prétoire*. 27 avril 2026.
