...
| 🟥 Gouverner la prolifération | **CC-14** | Power users & saaspocalypse — apps maison sans coder | ✅ Livré (JSON + MD + 5 SVG + HTML) | [HTML](CC-14-power-users.html) · [MD](cases/CC-14-power-users.md) · [JSON](cases/CC-14-power-users.json) · [Spec](PROPOSITION-cas-power-users.md) |
