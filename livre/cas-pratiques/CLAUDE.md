...
| 🟥 Gouverner la prolifération | **CC-14** | Power users & saaspocalypse — apps maison sans coder | 🖊️ Rédigé couche auteur (JSON + MD + 5 SVG : fig-00 sprawl civile, fig-01 socle d'enablers, fig-02 cycle de vie + design patterns, fig-03 pipeline gateway, fig-04 pipeline d'usage power users) — HTML phase 2 | [MD](cases/CC-14-power-users.md) · [JSON](cases/CC-14-power-users.json) · [Spec](PROPOSITION-cas-power-users.md) |
