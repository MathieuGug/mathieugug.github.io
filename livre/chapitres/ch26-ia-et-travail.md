...
> [!INFO] Voir [Ch. 5 — Économie de l'inférence](ch05-economie-inference.md) · [Ch. 23 — ROI](ch23-roi-paradoxe-agentique.md) · [Ch. 24 — IA frugale](ch24-ia-frugale.md) · [Ch. 25 — Gouvernance](ch25-gouvernance-ai-act.md) · [Ch. 27 — Procès Musk v. Altman](ch27-proces-musk-altman.md)
> Le [Ch. 5](ch05-economie-inference.md) a posé le coût unitaire de l'inférence ; le [Ch. 23](ch23-roi-paradoxe-agentique.md) a mesuré ce que vaut un agent pour qui le déploie ; le [Ch. 24](ch24-ia-frugale.md) a chiffré l'externalité énergétique ; le [Ch. 25](ch25-gouvernance-ai-act.md) a posé les obligations légales. Saut d'échelle ici : la question macroéconomique et politique de la trajectoire. Le [Ch. 27](ch27-proces-musk-altman.md) prolongera en regardant comment le contentieux juridique cristallise les positions doctrinales — *safety hard*, *scaling efficient*, *governance-as-service*. ==Pris ensemble, ces deux chapitres forment le contrefort sociétal du livre== — sans eux, l'analyse technique reste cohérente mais socialement incomplète.

---

## 26.2 Le malentendu fondamental — pourquoi les chiffres ne se comparent pas
...
### 26.2.1 Ce que mesure réellement Goldman Sachs
...
### 26.2.3 Trois confusions structurantes
...
## 26.3 L'IA comme *general-purpose technology* — ce que l'histoire prédit
...
### 26.3.1 Ce que ce cadre prédit — trois enseignements load-bearing
...
### 26.3.2 Ce qui pourrait être différent cette fois
...
### 26.4.1 Étape 1 — la granularité (profession vs tâche)
...
### 26.4.2 Étape 2 — la source du jugement
...
### 26.4.3 Étape 3 — la métrique d'exposition
...
### 26.4.4 Étape 4 — exposition vs complémentarité (le pivot FMI)
...
### 26.4.5 Étape 5 — la conversion en impact
...
## 26.5 Ce que les études empiriques mesurent — la compression par le bas
...
### 26.5.1 Brynjolfsson, Li, Raymond — le centre d'appel (2023)
...
### 26.5.2 Noy, Zhang — la rédaction (2023, *Science*)
...
### 26.5.3 Peng et al. — le développement logiciel (2023, GitHub Copilot)
...
### 26.5.4 Anthropic Economic Index — la mesure en continu (2025-2026)
...
### 26.5.5 Le *caveat* central — sélection, nouveauté, équilibre général
...
### 26.6.2 Pourquoi ce précédent revient dans le débat IA
...
Mais l'enseignement structurel reste : ==les gains de productivité ne se redistribuent pas automatiquement. C'est une conquête institutionnelle==. Le [Ch. 23](ch23-roi-paradoxe-agentique.md), en mesurant le ROI agent par agent, donne le numérateur ; ici, on rappelle qu'il n'y a pas de mécanisme automatique qui transforme ce numérateur en bien-être médian.

### 26.6.3 Le palier électrique — pourquoi il faut être patient
...
## 26.7 Quatre scénarios pour 2035
...
### 26.7.1 Scénario A — Productivité partagée
...
### 26.7.2 Scénario B — La pause d'Engels 2.0
...
## 26.8 Six leviers contre la catastrophe
...
### 26.8.1 Levier 1 — Redirection technologique
...
### 26.8.2 Levier 2 — Formation continue à grande échelle
...
### 26.8.3 Levier 3 — Sécurisation des transitions professionnelles
...
### 26.8.4 Levier 4 — Partage des gains : fiscalité et négociation
...
### 26.8.5 Levier 5 — Gouvernance des modèles

Ce levier est techniquement le plus complexe et politiquement le plus instable. Il concerne la régulation des grands modèles d'IA eux-mêmes : transparence d'entraînement, évaluation préalable, audit, responsabilité. C'est l'objet du **[Ch. 25](ch25-gouvernance-ai-act.md)** — l'AI Act européen (entré en application graduelle 2024-2026), les *executive orders* américains successifs, et les codes de conduite volontaires.
...
## 26.9 Le cas français — adoption lente, dialogue social structuré, fracture territoriale
...
### 26.9.1 La position d'Aghion-Bouverot — croissance d'abord
...
### 26.9.2 La position de France Stratégie — transformer plutôt que protéger
...
### 26.9.3 Données INSEE/DARES — l'adoption ralentie
...
Ce que le débat français pourrait gagner à intégrer plus clairement : **les six leviers concrets de redistribution des gains** du §26.8, sur lesquels l'économie politique (Acemoglu-Johnson, Korinek) a beaucoup à dire et que la conversation française médiatique aborde peu.

---

## 26.10 Récap chapitre — trois propositions load-bearing
...
Le [Ch. 27](ch27-proces-musk-altman.md) prend la suite en regardant **comment cette question politique se cristallise dans un contentieux judiciaire concret** — le procès Musk v. Altman, dont la phase 1 s'est ouverte à Oakland le 27 avril 2026 et dont le verdict du 18 mai 2026 a redistribué le dossier sur trois arènes parallèles. Le procès ne tranche pas la question politique ; il en pose les positions doctrinales en termes juridiquement opposables. ==La question (qui contrôle la direction) est posée ici ; le [Ch. 27](ch27-proces-musk-altman.md) montre qui tente d'y répondre devant un jury, et avec quelle issue.==
