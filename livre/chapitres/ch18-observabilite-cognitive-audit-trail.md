...
## 18.1 La rupture paradigmatique — du déterministe au probabiliste

### 18.1.1 Vingt-cinq ans de paradigmes empilés
...
### 18.1.2 Les quatre angles morts de l'APM classique
...
## 18.2 Les six piliers de la télémétrie agentique
...
### 18.2.1 Usage et tokens — le pilier le plus opérationnel
...
### 18.2.2 Performance — latence de bout en bout, TTFT, throughput
...
> Aucun des six piliers n'est suffisant seul. ==Un coût qui explose **sans** drift de qualité signale un problème de routing ; un drift de qualité **sans** surcoût signale un problème de prompt ou de modèle ; un drift comportemental **sans** drift de qualité signale soit que le nouveau chemin est meilleur, soit que la métrique ne capte pas ce qui s'est cassé.== C'est le croisement qui produit le diagnostic — et c'est précisément ce que le bus d'observabilité §18.3 est conçu pour rendre possible.

---

## 18.3 Architecture de référence — le bus d'observabilité comme colonne vertébrale
...
## 18.4 OpenTelemetry GenAI — le standard d'instrumentation

### 18.4.1 La coalition et le statut
...
### 18.4.2 Les quatre types de spans
...
- **Events** — `gen_ai.client.inference.operation.details` capture les payloads en opt-in ; `gen_ai.evaluation.result` attache un score de qualité directement au span de l'opération évaluée, plutôt que de le stocker séparément. C'est ce dernier point qui rend l'éval continue (§18.5) techniquement faisable.

### 18.4.3 Un instrument, N backends — la promesse OTel pour l'IA
...
## 18.5 Boucles de correction — du blocage 100 ms au refactor
...
### 18.5.1 Trois pratiques qui structurent un alerting mature
...
## 18.6 Le cognitive audit trail — réponse AI Act, RGPD, DORA

### 18.6.1 La nouvelle catégorie de log
...
### 18.6.2 Ce que doit contenir un cognitive audit trail bien fait
...
## 18.7 Échelle de maturité — cinq niveaux, un palier critique
...
### 18.7.2 Les agents d'observabilité — N5 et la question récursive
...
## 18.8 Cartographie du marché — incumbents APM × challengers AI-native
...
### 18.8.1 Incumbents APM — la course au rattrapage AI-native
...
### 18.8.2 Challengers AI-native — l'évaluation comme primitive
...
## 18.9 Récap chapitre — quatre disciplines, un standard
