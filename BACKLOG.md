...
## En cours / prio haute
- [ ] machine-unlearning · oubli prouvable au niveau des poids — RGPD art. 17 + AI Act art. 10 (août 2026) + CNIL juin 2025, taxonomie 4 familles (SISA / NPO / RMU / influence+LoRA), benchmarks TOFU/WMDP/MUSE/OpenUnlearning, faille structurelle (relearning bénin, REBEL, SMIA), pipeline d'audit et distillation robustifies

## Deep dives candidats sur dossiers existants
- donnees-synthetiques (déjà couvert 2026-05-29) : suites naturelles = (a) deep dive sur les corpus de référence humain-vérifié (FineWeb-Edu, DCLM, RedPajama-V3 — état de l'art curation collective) ; (b) instrumentation pratique de la biodiversité statistique en production (quels prompts adversaires, quelles métriques d'entropie, quel cadencier d'audit) ; (c) machine unlearning au niveau des poids — recoupe compaction-agentique mais sous l'angle data-deletion (CNIL/EDPS guidelines 2026, retraining-free unlearning).
...
- compaction-agentique (déjà couvert) : suite naturelle = (a) machine unlearning au niveau des poids (CNIL / EDPS guidelines 2025-2026, retraining-free unlearning papers 2025) ; (b) deep dive ledger OTel — quels attributs concrets, état du WG, premiers déployeurs
