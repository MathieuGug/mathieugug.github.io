...
## En cours / prio haute
- [ ] 2026-05-27 · compaction-agentique · deep dive sur `memoire-agentique` — compaction et oubli sélectif. 1M tokens ≠ solution (Lost in the Middle Liu 2024), taxonomie 5 familles (summarization, eviction StreamingLLM/H2O/Quest, hiérarchique MemGPT/Letta, retrieval Mem0/Zep/A-MEM, compactors appris), triangle fidélité × coût × oubli, matrice production (Claude Code, Cursor, ChatGPT, Mem0, Letta), surface d'attaque cachée (memory poisoning persistant SpAIware/ZombieAgent), RGPD + AI Act art 25 et le droit à l'oubli appliqué aux résumés.
